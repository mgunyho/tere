...
mod tests {
    ...
    fn test_scrolling_bufsize_less_than_window_size() {
        ...
        for i in 1..=3 {
            state.move_cursor(1);
            assert!(state.cursor_pos == i);
            assert!(state.scroll_pos == 0);
        }
    ...
    fn test_scrolling_bufsize_larger_than_window_size() {
        ...
        for i in 1..=6 {
            ...
            assert!(state.cursor_pos == 3);
            assert!(state.scroll_pos == i);
        }

        assert!(state.scroll_pos == 6);
